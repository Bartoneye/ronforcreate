...
public class ResourceCosts {
    ...
    public static final ResourceCost ENGINEER = new ResourceCost(ID, "ENGINEER");
    ...
    public static final ResourceCost DRAGON = new ResourceCost(ID, "DRAGON");
    ...
    public static final ResourceCost HAUNTED_GATE = new ResourceCost(ID, "HAUNTED_GATE");
    public static final ResourceCost HAUNTED_WALL = new ResourceCost(ID, "HAUNTED_WALL");
    //Villagers
    ...
    public static final ResourceCost STONEWALL = new ResourceCost(ID, "STONEWALL");
    public static final ResourceCost STONE_GATE = new ResourceCost(ID, "STONE_GATE");
    //Piglins
    ...
    public static final ResourceCost BLAZE_WATCHTOWER = new ResourceCost(ID, "BLAZE_WATCHTOWER");
    ...
    public static void deferredLoadResourceCosts() {
        ...
        ENGINEER.bakeValues(ReignOfNetherCommonConfigs.UnitCosts.ENGINEER);
        ...
        HAUNTED_GATE.bakeValues(ReignOfNetherCommonConfigs.BuildingCosts.HAUNTED_GATE);
        HAUNTED_WALL.bakeValues(ReignOfNetherCommonConfigs.BuildingCosts.HAUNTED_WALL);
        // Villagers
        ...
        STONEWALL.bakeValues(ReignOfNetherCommonConfigs.BuildingCosts.STONEWALL);
        STONE_GATE.bakeValues(ReignOfNetherCommonConfigs.BuildingCosts.STONE_GATE);
        // Piglins
        ...
        BLAZE_WATCHTOWER.bakeValues(ReignOfNetherCommonConfigs.BuildingCosts.BLAZE_WATCHTOWER);
