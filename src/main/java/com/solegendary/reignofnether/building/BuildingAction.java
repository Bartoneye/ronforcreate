...
public enum BuildingAction {
    ...
    CHANGE_PORTAL,// changes a gate clientside to match server when another player upgrades it
    GATE_OPEN,// changes a portal clientside to match server when another player upgrades it
    GATE_SHUT, //changes state of the gate open or closed clientside to match server when another player upgrades it
