...
import com.solegendary.reignofnether.unit.units.gaia.DragonProd;
    ...
    public static boolean startProductionItem(ProductionBuilding building, String itemName, BlockPos pos) {
        ...
        if (building != null) {
            ...
            switch(itemName) {
                ...
                case EngineerProd.itemName -> prodItem = new EngineerProd(building);
                ...
                case DragonProd.itemName -> prodItem = new DragonProd(building);
