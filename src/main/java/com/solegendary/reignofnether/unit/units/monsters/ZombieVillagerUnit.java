...
public class ZombieVillagerUnit extends Vindicator implements Unit, WorkerUnit, AttackerUnit, ArmSwingingUnit {
    ...
    public ZombieVillagerUnit(EntityType<? extends Vindicator> entityType, Level level) {
        ...
        if (level.isClientSide()) {
            ...
            this.abilityButtons.add(HauntedWall.getBuildButton(Keybindings.keyO));
            this.abilityButtons.add(HauntedGate.getBuildButton(Keybindings.keyP));
            this.abilityButtons.add(Stronghold.getBuildButton(Keybindings.keyC));
            this.abilityButtons.add(DarkWatchtower.getBuildButton(Keybindings.keyV));
            this.abilityButtons.add(SpruceBridge.getBuildButton(Keybindings.keyF));
            this.abilityButtons.add(SculkCatalyst.getBuildButton(Keybindings.keyG));
            this.abilityButtons.add(SlimePit.getBuildButton(Keybindings.keyL));
        }
    }
