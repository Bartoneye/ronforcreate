...
@OnlyIn(Dist.CLIENT)
public class EngineerUnitRenderer extends AbstractVillagerUnitRenderer<AbstractIllager> {
    private static final ResourceLocation ENGINEER_UNIT = new ResourceLocation("reignofnether", "textures/entities/engineer_unit.png");

    public EngineerUnitRenderer(EntityRendererProvider.Context context) {
