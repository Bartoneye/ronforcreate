...
public class DragonUnitFireball extends LargeFireball {

    public static final int SOULSAND_DURATION = 0;

    public DragonUnitFireball(Level pLevel, LivingEntity pShooter, double pOffsetX, double pOffsetY, double pOffsetZ, int pExplosionPower) {
    ...
    protected void onHit(HitResult pResult) {
        ...
        if (getOwner() instanceof DragonUnit dragonUnit) {
