...
public class ItemRegistrar {
    ...
    public static final RegistryObject<ForgeSpawnEggItem> ENGINEER_UNIT_SPAWN_EGG =
            ITEMS.register("engineer_unit_spawn_egg", () -> new ForgeSpawnEggItem(EntityRegistrar.ENGINEER_UNIT,
                    0x523632, 0x946F66, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
    ...
    public static final RegistryObject<ForgeSpawnEggItem> DRAGON_UNIT_SPAWN_EGG =
            ITEMS.register("dragon_unit_spawn_egg", () -> new ForgeSpawnEggItem(EntityRegistrar.DRAGON_UNIT,
                    1115418, 6496916, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
