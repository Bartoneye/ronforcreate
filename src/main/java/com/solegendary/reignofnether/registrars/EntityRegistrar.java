...
public class EntityRegistrar {
    ...
    public static final RegistryObject<EntityType<EngineerUnit>> ENGINEER_UNIT = ENTITIES.register("engineer_unit",
            () -> EntityType.Builder.of(EngineerUnit::new, MobCategory.CREATURE)
                    .sized(EntityType.VILLAGER.getWidth(), EntityType.VILLAGER.getHeight())
                    .clientTrackingRange(UNIT_CLIENT_TRACKING_RANGE)
                    .build(new ResourceLocation(ReignOfNether.MOD_ID, "engineer_unit").toString()));
    ...
    public static final RegistryObject<EntityType<DragonUnit>> DRAGON_UNIT = ENTITIES.register("dragon_unit",
            () -> EntityType.Builder.of(DragonUnit::new, MobCategory.CREATURE)
                    .sized(EntityType.ENDER_DRAGON.getWidth(), EntityType.ENDER_DRAGON.getHeight())
                    .clientTrackingRange(UNIT_CLIENT_TRACKING_RANGE)
                    .build(new ResourceLocation(ReignOfNether.MOD_ID, "dragon_unit").toString()));
