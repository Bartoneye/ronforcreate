...
public class ReignOfNetherCommonConfigs {
    ...
    static {
        ...
        UnitCosts.ENGINEER.define(BUILDER);
        ...
        //Neutral
        BUILDER.comment("Neutral");
        UnitCosts.DRAGON.define(BUILDER);
        ...
        BuildingCosts.HAUNTED_GATE.define(BUILDER);
        BuildingCosts.HAUNTED_WALL.define(BUILDER);
        //Villagers
        BUILDER.comment("Villagers");
        ...
        BuildingCosts.STONEWALL.define(BUILDER);
        BuildingCosts.STONE_GATE.define(BUILDER);
        //Piglins
        BUILDER.comment("Piglins");
        ...
        BuildingCosts.BLAZE_WATCHTOWER.define(BUILDER);
    ...
    public static class UnitCosts implements Costs {
        ...
        public static final ResourceCostConfigEntry ENGINEER = ResourceCostConfigEntry.Unit(50,0,25,20,1, ResourceCosts.ENGINEER, "Engineer Config");
        ...
        // Neutral
        public static final ResourceCostConfigEntry DRAGON = ResourceCostConfigEntry.Unit(100, 0, 50, 30,5, ResourceCosts.DRAGON, "Dragon Config");
    ...
    public static class BuildingCosts implements Costs {
        ...
        public static final ResourceCostConfigEntry HAUNTED_GATE = ResourceCostConfigEntry.Building(0, 100, 100, 0, ResourceCosts.HAUNTED_GATE, "Haunted Gate Config");
        public static final ResourceCostConfigEntry HAUNTED_WALL = ResourceCostConfigEntry.Building(0, 50, 50, 0, ResourceCosts.HAUNTED_WALL, "Haunted Wall Config");
        ...
        public static final ResourceCostConfigEntry STONEWALL = ResourceCostConfigEntry.Building(0, 50,50,0, ResourceCosts.STONEWALL, "Stone Wall Config");
        public static final ResourceCostConfigEntry STONE_GATE = ResourceCostConfigEntry.Building(0, 100, 100, 0, ResourceCosts.STONE_GATE, "Stone Gate Config");
        // Piglins
        ...
        public static final ResourceCostConfigEntry BLAZE_WATCHTOWER = ResourceCostConfigEntry.Building(0, 75, 100, 0, ResourceCosts.BLAZE_WATCHTOWER, "Blaze Watchtower Config");
    }
