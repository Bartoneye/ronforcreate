...
public class CommonModEvents {
    ...
    public static void registerRenderers(EntityRenderersEvent.RegisterRenderers evt) {
        ...
        evt.registerEntityRenderer(EntityRegistrar.ENGINEER_UNIT.get(), EngineerUnitRenderer::new);
        ...
        evt.registerEntityRenderer(EntityRegistrar.DRAGON_UNIT.get(), EnderDragonRenderer::new);
    }
    ...
    public static void registerAttributes(EntityAttributeCreationEvent evt) {
        ...
        evt.put(EntityRegistrar.ENGINEER_UNIT.get(), EngineerUnit.createAttributes().build());
        ...
        evt.put(EntityRegistrar.DRAGON_UNIT.get(), DragonUnit.createAttributes().build());
    }
